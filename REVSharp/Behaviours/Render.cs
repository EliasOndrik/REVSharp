...
namespace REVSharp.Behaviours
{
    public class Render : Behaviour
    {
        ...
        {
            uint cameraMask = componentManager.GetComponentMask<Camera>() | componentManager.GetComponentMask<Transform>();
            ...
            foreach (var entity in Entities)
            {
                ...
                ref ModelId mesh = ref componentManager.GetComponent<ModelId>(in entity);
                if (!mesh.IsVisible)
                {
                    continue;
                }
